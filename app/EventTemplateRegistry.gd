...
static func _register_hits(templates: Dictionary) -> void:
	_add_template(templates, _plate_appearance_template(
		...
		[WIDGET_COUNT_ENTRY, WIDGET_HIT_DETAILS, WIDGET_RUNNER_ADVANCEMENT_GRID, WIDGET_BASIC_FIELDER_ASSIGNMENT, WIDGET_EVENT_SUMMARY, WIDGET_MANUAL_OVERRIDES],
...
static func _register_batted_ball_outs(templates: Dictionary) -> void:
	_add_template(templates, _plate_appearance_template("groundout", EVENT_GROUP_BATTED_BALL_OUTS, "Groundout", ["out_type", "primary_fielder_id", "outs_added"], ["assist_fielder_ids", "putout_fielder_id", "throw_to_base", "runner_advancements", "rbi_if_runner_scores"], [WIDGET_COUNT_ENTRY, WIDGET_BATTED_BALL_OUT_DETAILS, WIDGET_RUNNER_ADVANCEMENT_GRID, WIDGET_BASIC_FIELDER_ASSIGNMENT, WIDGET_EVENT_SUMMARY, WIDGET_MANUAL_OVERRIDES], {"outs_added": 1, "batter_out": true, "runners_hold_by_default": true}, {"plate_appearance": 1, "at_bat": 1, "groundout": 1}, ["requires_current_batter", "requires_current_pitcher", "requires_primary_fielder_or_unknown", "outs_added_at_least_one", "outs_after_not_over_three_without_override", "validate_unique_occupied_bases_after"]))
